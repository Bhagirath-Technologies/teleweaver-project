...
<head>
  ...
  <link rel="icon" type="image/png" href="assets/img/fav_icons_white.svg" />
</head>
  ...
  <div class="navbar-area">
    <div class="evolta-responsive-nav">
      <div class="container">
        <div class="evolta-responsive-menu">
          <div class="logo">
            <a href="index.html">
              <img src="assets/img/logo/color-logo.svg" width="120px" alt="logo" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-light">
          <a class="navbar-brand" href="index.html">
            <img src="assets/img/logo/color-logo.svg" width="140px" alt="logo" />
          </a>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item">
                    <a href="services-1.html" class="nav-link">Service 1</a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="single-services.html" class="nav-link">Services 3</a>
                  </li>
                  <li class="nav-item">
                    <a href="single-services.html" class="nav-link">Services 4</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
            ...
            <div class="row align-items-center">
              <div class="col-lg-6 col-md-12">
                <div class="main-banner-content">
                  <h1>World’s Leading IOT Company</h1>
                  <p>
                    Chatbots today are able to supply needful of help,
                    information, and positive experience of maintaining intimacy
                    with customers. Eventually, chatbot ideas bring a pleasant
                    experience of all these qualities into the conversation,
                    making the conversation experience richer and useful for
                    businesses.
                  </p>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="main-banner-image">
                  <img src="assets/img/banner-img1.svg" alt="image" />
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="features-area ptb-110 bg-f7f9fc">
      <div class="container">
        <div class="overview-box">
          <div
            class="image wow animate__animated animate__zoomIn"
            data-wow-delay="1s"
          >
          ...
          <div class="content">
            ...
            <ul class="features-list">
              <li>
                <span
                  ><i class="bx bx-check-double"></i> Influencing Sales</span
                >
              </li>
              <li>
                <span
                  ><i class="bx bx-check-double"></i> Generating Insights</span
                >
              </li>
              <li>
                <span
                  ><i class="bx bx-check-double"></i> Engaging Customer</span
                >
              </li>
              <li>
                <span
                  ><i class="bx bx-check-double"></i> Boosting Operations</span
                >
              </li>
            </ul>
          </div>
        ...
        <div class="overview-box">
          <div class="content">
            ...
            <ul class="features-list">
              <li>
                <span><i class="bx bx-check-double"></i> Fully Support</span>
              </li>
              <li>
                <span
                  ><i class="bx bx-check-double"></i> Reliable & Cost
                  Effective</span
                >
              </li>
              <li>
                <span
                  ><i class="bx bx-check-double"></i> Dedicated Developers</span
                >
              </li>
              <li>
                <span
                  ><i class="bx bx-check-double"></i> 100% Customer
                  Satisfaction</span
                >
              </li>
            </ul>
      ...
      <div class="rectangle-shape1">
        <img src="assets/img/rectangle-shape1.png" alt="image" />
      </div>
      <div class="rectangle-shape2">
        <img src="assets/img/rectangle-shape2.png" alt="image" />
      </div>
    </section>
    <!-- End Features Area -->
    ...
    <section class="services-area ptb-110 bg-fafafa pb-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-services-box">
              <div class="icon">
                <img
                  src="assets/img/services/augmented-reality.png"
                  alt="image"
                />
              </div>
      ...
      <div class="services-shape">
        <img src="assets/img/services-shape.png" alt="image" />
      </div>
    </section>
    <!-- End Services Area -->
    ...
    <section class="feedback-area">
      ...
      <div class="feedback-shape">
        <img src="assets/img/white-shape2.png" alt="image" />
      </div>
          ...
          <div class="col-lg-5 col-md-12">
            <div class="newsletter-content">
              ...
              <form class="newsletter-form" data-toggle="validator">
                ...
                />
                <button type="submit">
                  Subscribe <i class="flaticon-paper-plane"></i>
                </button>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="single-footer-widget">
              ...
              <ul class="footer-contact-list">
                ...
                <li><span>Email:</span> <a href="#">btpl@gmail.com</a></li>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <p>
                ...
                <a href="https://www.bhagirathtechnologies.com/" target="_blank"
                  >Bhagirath Technologies Pvt Lmt</a
                >
              </p>
            </div>
